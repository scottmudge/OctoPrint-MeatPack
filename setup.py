...
plugin_identifier = "meatpack"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "OctoPrint_MeatPack"
...
plugin_version = "1.3.35"

# The plugin's description. Can be overwritten within OctoPrint's internal data via __plugin_description__ in the plugin
# module
plugin_description = "A real-time, CPU-easy, gcode compression/packing algorithm developed by Scott Mudge"

# The plugin's author. Can be overwritten within OctoPrint's internal data via __plugin_author__ in the plugin module
plugin_author = "Scott Mudge"

# The plugin's author's mail address.
plugin_author_email = "mail@scottmudge.com"
